      ...
      >
        ...
        >
          {files.map(file => {
            ...
            const isCurrentPresentation = file.id === currentPresentationId;
            return (
              <li key={file.id} className="files-list-item">
                <ActivityDot show={isCurrentPresentation} status="on" />
                <div className="files-list-item-details">
                  <FilesListItemTitle
                    id={file.id}
                    title={file.title}
                    path={path}
                    onClick={e => this.handleItemClick(e, file.id)}
                  />
                  <FilesListItemModifiedAt value={file.modifiedAt} />
                </div>
